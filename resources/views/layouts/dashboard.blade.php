...
<html lang="en-us" class="no-js">
	<head>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="{{url('/')}}/styles/css/demo.min.css">

		<!-- #FAVICONS -->
		<!-- <link rel="shortcut icon" href="{{url('/')}}/styles/img/favicon/favicon.ico" type="image/x-icon"> -->
	...
	* 'data-smart-page-title'    - Page title
	...
	<body data-smart-device-detect
		...
		data-smart-layout
		data-smart-page-title="Real Estate">
